...
},{"regenerator-runtime":"node_modules/regenerator-runtime/runtime.js"}],"node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{"buffer":"node_modules/buffer/index.js"}],"js/chart.js":[function(require,module,exports) {
"use strict";
...
var amount = function amount(list) {
  var totalPrice = list.reduce(function (prev, curr) {
    switch (curr.inOut) {
      case 'out':
...
var dayUseWrap = document.querySelector('.day-use__wrap');
var dailyLabels = [];
var dailyValues = [];

var dailyArrData = function dailyArrData(data) {
  // 일별로 데이터 분류
  // const dateArr = groupBy(data, 'date');
  var dateArr = _lodash.default.groupBy(data, 'date'); // 날짜를 기준으로 나머지 데이터 묶음


  var _loop = function _loop() {
    var _Object$entries$_i = (0, _slicedToArray2.default)(_Object$entries[_i], 2),
        dateText = _Object$entries$_i[0],
        dailyList = _Object$entries$_i[1];

    var totalPrice = amount(dailyList);
    ...
    var dayHistoryUl = document.createElement('ul');
    itemWrap.className = 'itemWrap';
    dayHistoryUl.className = 'history';
    itemWrap.innerHTML = "\n      <div class=\"day-total\"> \n        <h3 class=\"day\">".concat(dateText, "</h3>\n        <h3 class=\"day-spend\">").concat(totalPrice.toLocaleString(), "\uC6D0 \uC9C0\uCD9C</h3>\n      </div>\n    ");
    ...
    dailyList.forEach(function (item) {
      ...
      HistoryLi.innerHTML = "\n        <h3 class=\"item\">".concat(item.item, "</h3>\n        <h3 class=\"").concat(item.inOut === 'in' ? 'price-in' : 'price-out', "\">\n          ").concat(item.inOut === 'in' ? '+' + item.price.toLocaleString() : item.price.toLocaleString(), "\uC6D0\n        </h3>\n      ");
      dayHistoryUl.appendChild(HistoryLi);
    });
  };

  for (var _i = 0, _Object$entries = Object.entries(dateArr); _i < _Object$entries.length; _i++) {
    _loop();
  }
};
/* 
...
var monthUl = document.querySelector('.month__list');
var monthLabels = [];
var monthValues = []; // console.log(monthValues);

var monthArrData = function monthArrData(data) {
  // 4월만 필터하기
  var aprilData = data.filter(function (e) {
    return e.date.includes('2022.4');
  }); // 4월 데이터를 타입으로 분류
  // const aprilTypeArr = groupBy(aprilData, 'type');

  var aprilTypeArr = _lodash.default.groupBy(aprilData, 'type'); // 타입을 기준으로 나머지 묶음


  var _loop2 = function _loop2() {
    var _Object$entries2$_i = (0, _slicedToArray2.default)(_Object$entries2[_i2], 2),
        typeText = _Object$entries2$_i[0],
        typeValue = _Object$entries2$_i[1];

    // 타입 총합 구하기
    var totalPrice = amount(typeValue);
  ...
  for (var _i2 = 0, _Object$entries2 = Object.entries(aprilTypeArr); _i2 < _Object$entries2.length; _i2++) {
    _loop2();
  }
};
/* 
...
var dayilyCtx = document.getElementById('daily-canvas').getContext('2d');
var gradient = dayilyCtx.createLinearGradient(0, 0, 0, 400);
...
var monthCtx = document.getElementById('month-canvas').getContext('2d');
var myChart = new Chart(monthCtx, {
  type: 'doughnut',
  data: {
    labels: monthLabels,
    datasets: [{
  ...
  options: {
    ...
    plugins: {
      ...
      title: {
        display: false // text: `총 ${monthValues.reduce((c, n) => {
        //   return c + n
        // })}원`,
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/chart.js"], null)
//# sourceMappingURL=/chart.45e8b4b7.js.map